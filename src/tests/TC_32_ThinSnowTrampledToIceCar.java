 ...
 * 
 * Use-case neve: TC_32_THIN_SNOW_TRAMPLED_TO_ICE_CAR
 * 
 * Rövid leírás:
 * Egy vékony hóval borított sávra ráhajt a húszadik jármű (Car), amelynek súlya
 ...
 */
public class TC_32_ThinSnowTrampledToIceCar extends TestCase {
    @Override
    public void run() {
